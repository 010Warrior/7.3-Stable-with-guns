...
namespace Hooks
{
    ...
    */
    ...
    APlayerController* SpawnPlayActor(UWorld* World, UPlayer* NewPlayer, ENetRole RemoteRole, FURL& URL, void* UniqueId, SDK::FString& Error, uint8_t NetPlayerIndex)
    {
        ...
        int consumable_count = 6;
        auto weapon1 = ItemDefinitions::GetWeapon(false, ItemDefinitions::WeaponItemDefinitionNames::AssaultRifle_Blue);
        Abilities::Inventory::AddNewItem(PlayerController, weapon1, 1, EFortQuickBars::Primary, 1);
        auto weapon2 = ItemDefinitions::GetWeapon(false, ItemDefinitions::WeaponItemDefinitionNames::PumpShotgun_Blue);
        Abilities::Inventory::AddNewItem(PlayerController, weapon2, 2, EFortQuickBars::Primary, 1);
        auto weapon3 = ItemDefinitions::GetWeapon(false, ItemDefinitions::WeaponItemDefinitionNames::BoltAction_Gold);
        Abilities::Inventory::AddNewItem(PlayerController, weapon3, 3, EFortQuickBars::Primary, 1);
        auto weapon4 = ItemDefinitions::GetWeapon(false, ItemDefinitions::WeaponItemDefinitionNames::SMG_Blue);
        Abilities::Inventory::AddNewItem(PlayerController, weapon4, 4, EFortQuickBars::Primary, 1);
        auto consumable = ItemDefinitions::GetConsumable(false, &consumable_count, ItemDefinitions::ConsumableItemDefinitionNames::Shields);
